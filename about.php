...
<div
        ...
        >
          ...
          >
            ...
            >
          	...
          	<p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-3"><a href="index.php">Home  >> </a></span> <span>About</span></p>
    ...
    <section class="ftco-about d-md-flex">
        ...
        <div>
  				<p>The Magazine Management System is a web-based application designed to simplify the process of college magazine publication by providing a centralized platform for managing and publishing content. With its user-friendly interface and role-based access controls, the Magazine Management System offers a range of functionalities. From uploading and reviewing content to managing departments and approving articles, the system provides a streamlined workflow for magazine publication. Developed using PHP and powered by a robust database, the system is designed for scalability and performance, making it an ideal solution for colleges of all sizes.</p>
  			</div>
    	</div>
    </section>
    <?php 
