                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <?php 
                      ...
                      $query = "select a.id, a.title, a.category, a.file, a.uploaddate, a.status, a.comment, a.stud_id, d.d_name FROM articles AS a RIGHT JOIN users AS u ON a.stud_id = u.id RIGHT JOIN department AS d ON u.deptno = d.id WHERE d.d_name = '$stud_dept' and a.stud_id != 'NULL'";
                      $result = mysqli_query($connect, $query);
