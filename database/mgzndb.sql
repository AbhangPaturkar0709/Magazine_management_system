...
-- Dumping database structure for mgzndb
CREATE DATABASE IF NOT EXISTS `mgzndb` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `mgzndb`;

-- Dumping structure for table mgzndb.articles
...
-- Dumping data for table mgzndb.articles: ~1 rows (approximately)
/*!40000 ALTER TABLE `articles` DISABLE KEYS */;
/*!40000 ALTER TABLE `articles` ENABLE KEYS */;

-- Dumping structure for table mgzndb.department
...
-- Dumping data for table mgzndb.department: ~9 rows (approximately)
...
-- Dumping structure for table mgzndb.magazines
...
-- Dumping data for table mgzndb.magazines: ~0 rows (approximately)
/*!40000 ALTER TABLE `magazines` DISABLE KEYS */;
/*!40000 ALTER TABLE `magazines` ENABLE KEYS */;

-- Dumping structure for table mgzndb.users
...
-- Dumping data for table mgzndb.users: ~1 rows (approximately)
