...
-- Dumping data for table magazinedb.articles: ~0 rows (approximately)
...
-- Dumping data for table magazinedb.department: ~8 rows (approximately)
...
-- Dumping data for table magazinedb.magazines: ~1 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKDEPTNO` (`deptno`),
  CONSTRAINT `FKDEPTNO` FOREIGN KEY (`deptno`) REFERENCES `department` (`id`) ON DELETE SET NULL ON UPDATE SET NULL
